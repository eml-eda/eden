...
fpath = "results/gbdt/gridsearch/unimib-gridsearch.csv"
ADAPTIVE_MODEL = "results/gbdt/adaptive/unimib-adaptive-baseline.json"
...
def deploy_grid(fpath_grid_search):
    ...
    for model in [*models.itertuples()][::-1]:
        ...
        X_test = deployment_subset(classifier, X_test, n_samples_out=300)
    ...
    output_fname_json = "unimib-adaptive-baseline.json"
...
def deploy_adaptive():
    ...
    for policy in ["aggregated-max", "aggregated-score-margin"]:
        ...
        with open("unimib-adaptive-baseline-deployed.json", "w") as f:
